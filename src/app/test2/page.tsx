  ...
  return (
    <div className="block max-w-full">
      <div className="flex md:block lg:block">
        <div className="flex flex-col items-center ml-2 mt-2 md:m-0 lg:m-0 w-full md:w-[200px] lg:w-[300px]">
          <div className="border-2 border-[#fed6ae] bg-[#1f1f1f] p-2 text-center">
            White's turn
          </div>
          <button className="hover:bg-[#fed6ae] hover:text-[#292929] border-2 border-[#fed6ae] bg-[#1f1f1f] p-2 mt-2 w-full">
            Reset board
          </button>
        </div>
        <div className="border-2 border-[#fed6ae] bg-[#1f1f1f] p-2 mt-2 ml-2 mr-2 w-full overflow-hidden">
          <div className="flex items-center space-x-2">
            <span className="shrink-0">FEN:</span>
            <p>

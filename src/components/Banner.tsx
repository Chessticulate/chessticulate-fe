  ...
  return (
    <nav className="relative flex justify-between items-center px-4 py-2 bg-[#1f1f1f]">
      <div className="lg:hidden">
        <button onClick={() => visible ? setVisible(false) : setVisible(true)} data-collapse-toggle="navbar-hamburger" type="button" className="inline-flex items-center justify-center p-2 w-10 h-10 hover:bg-[#fed6ae] hover:text-[#292929] focus:outline-none" aria-controls="navbar-hamburger" aria-expanded="false">
          <span className="sr-only">Open main menu</span>
          <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
              <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 1h15M1 7h15M1 13h15"/>
          </svg>
        </button>
        <div className={`${visible ? "flex" : "hidden"} bg-[#1f1f1f] absolute left-0 top-full mt-2 z-50`}>
